package com.codewithbhanuka.blog.exception;
...
public class GlobalExceptionHandler {
    ...
    //exception for not valid argument in the field
    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<Map<String, String>> handleMehodArgsNotValidException(MethodArgumentNotValidException ex){
        // In hash map not order, but order are Linked hash map and Tree map(implment by Sorted map)
